...
```bash
curl -sL https://raw.githubusercontent.com/YOUR_USERNAME/rekyoki-auto-rejoin/main/auto_rejoin.py -o auto_rejoin.py && pip install rich prompt_toolkit requests -q && python auto_rejoin.py
```
